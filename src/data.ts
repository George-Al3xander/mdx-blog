...
import { HeroData, TPostVariant, ThemeVariant } from "./types/types";
...
export const dbItemsCountFunctionMap = new Map<
    TPostVariant | "all",
    () => Promise<number>
>([
    ["all", getPublicationsCount],
    ["articles", getArticlesCount],
    ["programs", getProgramsCount],
]);
